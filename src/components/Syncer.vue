  ...
  data: function () {
    return {
      ...
      endpoints: [
        ...
        { api: 'book-relations', local: 'book-relations' },
        { api: 'books', local: 'books' },
        { api: 'book-items', local: 'book-items' },
        { api: 'book-locations', local: 'book-locations' },
        { api: 'book-genre-collections', local: 'book-genre-collections' },
        { api: 'book-chapters', local: 'book-chapters' },
        { api: 'book-chapter-versions', local: 'book-chapter-versions' },
        { api: 'book-characters', local: 'book-characters' },
        { api: 'book-relation-details', local: 'book-relation-details' },
        { api: 'book-scenes', local: 'book-scenes' },
        { api: 'book-scene-versions', local: 'book-scene-versions' },
        { api: 'book-scene-items', local: 'book-scene-items' },
        { api: 'book-scene-locations', local: 'book-scene-locations' },
        { api: 'book-scene-characters', local: 'book-scene-characters' }
      ]
    }
  },
  methods: {
