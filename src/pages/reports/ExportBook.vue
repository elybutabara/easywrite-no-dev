...
<style scoped>
/* .es-panel2 { margin:0px auto; margin-bottom:20px; padding:20px 20px; background:#e7e7e7; border:1px solid #e0e5ee; width:calc(100% - 40px); max-width:1320px;  }
.data-label {background-color:#e7e7e7; color: black;} */
