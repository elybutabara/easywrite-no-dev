    ...
    <div class="es-page-head">
        <div class="inner">
            ...
            <div class="actions">
                ...
                <button v-if="exportOnProgress === false" class="es-button-white" @click="exportScenes(book.uuid)">{{$tc('EXPORT', 1).toUpperCase()}} {{$tc('SCENE', 2).toUpperCase()}} {{$tc('LIST', 1).toUpperCase()}}</button>
