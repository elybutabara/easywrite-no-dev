<template>
  <div>
    <div v-if="page.is_ready" class="page-scene-details">
      <div class="es-page-head">
        <div class="inner">
          ...
          <div class="actions">
            <button ref="button" class="es-button-white" :disabled="busy" @click="newVersion()">SAVE AS NEW VERSION</button>
    ...
    <b-overlay :show="busy" no-wrap fixed @shown="this.$refs.dialog.focus()" @hidden="this.$refs.button.focus()">
                ...
                <b-row>
                  <b-col>
                    <div class="text-right">
                      <b-button variant="outline-dark" class="mr-2" @click="this.busy = !this.busy">Cancel</b-button>
