                ...
                <div class="es-col fadeIn animated" v-for="location in locations" v-bind:key="location.id">
                    <div class="es-card">
                        ...
                        <div class="es-card-footer">
                            <button class="btn-"  @click="CHANGE_COMPONENT({tabKey: 'location-details-' + location.uuid, tabComponent: 'location-details', tabData: { book_id: properties.uuid, location: location }, tabTitle:  location.location})"><i class="lar la-eye"></i> VIEW</button>
                            ...
                            <button class="btn-delete"  @click="deleteLocation(location)"><i class="las la-trash-alt"></i> DELETE</button>
                        </div>
                    </div>
                </div>
            </div>
